...
function onepage_styles() {
    ...
    wp_enqueue_style('carousel1', ONEPAGE_DIR_URI . 'owl-carousel/owl.carousel.css');
    wp_enqueue_style('carousel2', ONEPAGE_DIR_URI . 'owl-carousel/owl.theme.css');
    /**
     * Bootstrap CSS file
     */
    ...
    wp_enqueue_style('one-page-material-design', '//fonts.googleapis.com/icon?family=Material+Icons');
    /**
...
function onepage_scripts() {
    ...
    wp_enqueue_script('carousel-carousel', ONEPAGE_DIR_URI . 'assets/owl-carousel/owl.carousel.js', array('jquery'));
