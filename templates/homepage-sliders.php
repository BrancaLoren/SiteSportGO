							...
							<div class="sl-slide-inner">
								...
								<div class="slider_caption_wrapper">
									...
									<div class="slider_caption">
										...
										<ul class="col-xs-10 slide">
											<li>Encontre pessoas com as mesmas paixões esportivas</li>
											<li>Veja no mapa de sua cidade onde há eventos</li>
											<li>Marque um evento e convide seus amigos</li>
										</ul>

										

										<div class="row">
											<div class="col-xs-5 col-md-3 col-sm-3 cel">
												<img class="celular" src="wp-content/themes/one-page/assets/imagens/celular.png">
											</div>
										</div>
										...
										<div class="row google">
											<div class="col-xs-4 col-md-3 col-sm-3">
												<a href="https://play.google.com/store">
													<img class="img_google" src="wp-content/themes/one-page/assets/imagens/google.jpg">
												</a> 
											</div>
											<div class="col-xs-4 col-md-3 col-sm-3" >
												<img class="img_baixe" src="wp-content/themes/one-page/assets/imagens/baixeagora.png">
												<p>Baixe grátis agora!</p>
											</div>
										</div>
